        ...
        <div className="row get__started__section ">
          <div className="col col-lg-6 col-md-12 col-sm-12  text__section">
            <div className="text__section__title">
              Manage your all employees and fizz users all in one place.
            </div>
            <div className="text__section__subtitle">
              Admin can add employees and fizz users. And Employees can send any
              updates to fizz users via email.🎉
            </div>
            <div className="">
              {/* <button
          ...
          <div className="col col-lg-6 col-md-12 col-sm-12 order-lg-0 order-first image__section">
            <img
              src="https://res.cloudinary.com/proudposhak-com/image/upload/v1655207814/easypizi/person-using-currency-exchange-app_ajnfot.png"
              alt="getstarted"
